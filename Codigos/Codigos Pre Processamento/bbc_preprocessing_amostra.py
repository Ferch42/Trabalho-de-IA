...
bbc_path_amostra='../../bbc amostra/'

arquivos= os.listdir(bbc_path_amostra)

corpus=[]

for f in arquivos:
	corpus.append(open(bbc_path_amostra+f).read())
...
os.mkdir('ObjetosPreProcessados Amostra')
os.chdir('ObjetosPreProcessados Amostra')
