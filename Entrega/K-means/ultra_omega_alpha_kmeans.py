...
class ultra_omega_alpha_kmeans:
    ...
    - O k-means e executado em tres passos basicos:
        - Criacao do objeto com a especificacao dos parametros;
        - Execucao da funcao incluir(dados) para incluir a matriz de dados (Ex.: objetokmeans.incluir(dados));
        - Execucao da funcao inicializar();
        - Execucao da funcao executar(), ou executar_x_means() caso seja x-means.
    ...
    - Cada centroide esta representado por uma lista de inteiros que representam as coordenadas do
      centroide, e guardado em self.centroids. A ordem em que os centroides estao guardados condizem
      com a ordem em que os clusters estao guardados.
    - Os dados resultantes do pre-processamento sao incluidos em self.dados atraves da funcao incluir().
    - Depende do arquivo ultra_omega_alpha_kmeans2.py (copia) para a implementacao do x-means, pois
      precisa de uma instancia de si mesma.
    - Depende do arquivo silhuetaDInamico.py para o calculos de silhueta realizados na implementacao
      do x-means.
    - Para importar os arquivos, deve-se criar copias dos mesmos e coloca-los na mesma pasta deste codigo.
      Este mesmo procedimento vale para qualquer um dos scripts que contem dependencias de outros scripts.
    '''
    ...
    def inicializar(self):
        ...
        3 diferentes metodos, criando os centroides iniciais.
        '''
