...
if __name__ == "__main__":
    ...
    #######################################################################################################################################
    come_xuchu = pickle.load(open("../../../Objetos/Objetos Preprocessados Reuters/TF/3k/Lemma/arq_LSA.aug","rb"))
    ...
    come_xuchu_dict["distancia"] = "euclidiana"
    ...
    for i in range(5):
        ...
        while(flagg):
            try:
                kmeans = ultra_omega_alpha_kmeans.ultra_omega_alpha_kmeans(no_clusters=2,distancia="euclidiana",algoritmo="media")
    ...
    come_xuchu = pickle.load(open("../../../Objetos/Objetos Preprocessados Reuters/TF/3k/Lemma/arq.aug","rb"))
    if (not isinstance(come_xuchu, np.ndarray)):
        come_xuchu = np.array(come_xuchu.todense(), dtype=np.float64)
