...
for tipo_de_tamanho in tipos_de_tamanho:
    ...
    for tipo_de_tipo in tipos_de_tipo:
        ...
        for objeto in objetos:
            ...
            pickle.dump(transform_come_xuchu,open(path_arquivos+"../../../../ObjetosProcessados/"+escolha_da_representacao +"/"+tipo_de_tamanho +"/"+ tipo_de_tipo + "/"+ "bbc_" + escolha_da_representacao + "_" + tipo_de_tamanho + "_" + tipo_de_tipo + "_LSA" + str(lsa) +".tsne","rb")) 
            ...
            for algoritmo in algoritmos_do_kmenzao:
                ...
                for distancia in distancias_do_kmenzao:
                    ...
                    os.mkdir(path_arquivos+"../../../../ObjetosProcessados/" + escolha_da_representacao +"/"+tipo_de_tamanho +"/"+ tipo_de_tipo + "/" + comeu_chuxu)
                    pickle.dump(come_xuchu_dict,open(path_arquivos+"../../../../ObjetosProcessados/"+escolha_da_representacao +"/"+tipo_de_tamanho +"/"+ tipo_de_tipo + "/" + comeu_chuxu +"/"+ comeu_chuxu+".info","rb"))
                    pickle.dump(kmeans,open(path_arquivos+"../../../../ObjetosProcessados/"+escolha_da_representacao +"/"+tipo_de_tamanho +"/"+ tipo_de_tipo + "/" + comeu_chuxu +"/"+ comeu_chuxu+".cluster","rb"))
                    ...
                    pickle.dump(fig,open(path_arquivos+"../../../../ObjetosProcessados/"+escolha_da_representacao +"/"+tipo_de_tamanho +"/"+ tipo_de_tipo + "/" + comeu_chuxu +"/"+ comeu_chuxu+".art","rb"))
