    ...
    for tipo_de_tamanho in tipos_de_tamanho:
        ...
        for tipo_de_tipo in tipos_de_tipo:
            ...
            for objeto in objetos:
                ...
                # pickle.dump(transform_come_xuchu,open("../../../Objetos/ObjetosProcessados/"+escolha_da_representacao +"/"+tipo_de_tamanho +"/"+ tipo_de_tipo + "/"+ "reuters_" + escolha_da_representacao + "_" + tipo_de_tamanho + "_" + tipo_de_tipo + "_LSA" + str(lsa) +".tsne","wb"))
                ...
                for algoritmo in algoritmos_do_kmenzao:
                    ...
                    for distancia in distancias_do_kmenzao:
                        ...
                        filepath = os.path.realpath(
                            "../../../Objetos/ObjetosProcessadosPlusPlusReuters/" + escolha_da_representacao + "/" + tipo_de_tamanho + "/" + tipo_de_tipo + "/" + comeu_chuxu)
