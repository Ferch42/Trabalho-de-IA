...
reuters_amostra_path='../../reuters amostra/'

arquivos= os.listdir(reuters_amostra_path)

corpus=[]

for f in arquivos:
	corpus.append(open(reuters_amostra_path+f).read())
...
os.mkdir('Objetos Preprocessados Reuters Amostra')
os.chdir('Objetos Preprocessados Reuters Amostra')
